...
CREATE TABLE IF NOT EXISTS manual_entries (
    ...
    reference_data JSON, -- Store sale items or expense details
    created_by INT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE INDEX idx_sales_returns_original_sale_id ON sales_returns(original_sale_id);
...
CREATE INDEX idx_customer_reviews_sale_id ON customer_reviews(sale_id);
